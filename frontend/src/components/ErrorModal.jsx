  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white p-8 rounded-3xl shadow-2xl text-center max-w-sm w-full border border-white/20 transform scale-100 animate-in zoom-in duration-300">
        <div className="w-20 h-20 bg-red-100 text-red-600 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl font-bold">
            ✗
        </div>
        ...
        <button 
          onClick={onClose}
          className="w-full bg-red-600 text-white py-4 rounded-2xl font-bold text-xl hover:bg-red-700 transition duration-300 shadow-lg active:scale-95"
        >
          {buttonText}
        </button>
      </div>
